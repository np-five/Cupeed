...
public class ProductServiceV1 {
	...
	// }
	@Transactional
	public void decreaseStock(ProductStockDecreaseRequestDtoV1 requestDto) {
		for (ProductStockDecreaseRequestDtoV1.ProductStockDto item : requestDto.getProductStocks()) {
