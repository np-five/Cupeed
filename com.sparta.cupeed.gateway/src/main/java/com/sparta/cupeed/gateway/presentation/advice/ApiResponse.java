...
public class ApiResponse<T> {
	...
	public static ApiResponse<Void> error(GatewayError errorCode) {
	...
	public static ApiResponse<Void> error(GatewayError errorCode, BindingResult bindingResult) {
		return ApiResponse.<Void>builder()
			.status("FAIL")
			.code(errorCode.getCode())
			.message(errorCode.getMessage())
	...
	public static ApiResponse<Void> error(GatewayError errorCode, String message) {
		return ApiResponse.<Void>builder()
			.status("FAIL")
			.code(errorCode.getCode())
			.message(message)
